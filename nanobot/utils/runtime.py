...
SUSTAINED_GOAL_CONTINUE_PROMPT = (
    "You have an active sustained goal, but the user has not sent a new message. "
    "Do NOT narrate that you are waiting. Do NOT invent idle status lines. "
    "Do NOT install software, run long tool chains, or call complete_goal. "
    "Do NOT send another question, reminder, or buttons. "
    "If you can make progress with tools alone, continue that work. "
    "Otherwise produce NO user-visible text and stop immediately — "
    "stay silent until the user replies."
)
