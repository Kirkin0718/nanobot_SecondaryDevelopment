...
interface ThreadComposerProps {
  ...
  /** When true, hide the composer goal strip (header Journey/Progress owns goal chrome). */
  hideGoalChrome?: boolean;
...
function RunElapsedStrip({
  ...
  const stripLabel = hideGoalChrome ? null : goalStateStripPreview(goalState, t);
