...
export interface UIMessage {
  ...
  turnSeq?: number;
  /** Inline choice chips under an assistant reply (rows of labels). */
  buttons?: string[][];
  /** Structured UI from gateway (e.g. tool_approval). */
  agentUi?: AgentUIBlob;
}
...
export type InboundEvent =
  ...
  | ({
      ...
      /** Inline keyboard / choice chips (same shape as OutboundMessage.buttons). */
      buttons?: string[][];
    } & InboundTurnMetadata)
  | ({
      event: "file_edit";
...
export type Outbound =
  ...
  | {
      ...
      workspace_scope?: WorkspaceScopePayload;
      turn_id?: string;
      /** When true, do not show this user prompt in the WebUI chat transcript. */
      hidden_history?: boolean;
